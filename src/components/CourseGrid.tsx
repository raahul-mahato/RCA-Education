...
const CourseGrid: React.FC = () => {
  ...
  const categories = ["All", "SSC", "Railway", "WBPSC", "Police", "Banking"];
    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-extrabold text-rca-blue sm:text-4xl">
            Explore Our Courses
          </h2>
          <p className="mt-4 text-xl text-gray-500">
            Quality education at the most affordable price points.
          </p>
        </div>
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {course.tags.map((tag) => (
                    <span
                      key={tag}
                      className="text-[10px] bg-gray-50 text-gray-500 px-2 py-0.5 rounded border border-gray-100 uppercase font-medium"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="mt-auto flex items-center justify-between">
                  <span className="text-2xl font-black text-rca-blue">
                    {course.price}
                  </span>
